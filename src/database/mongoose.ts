...
const uri = 'mongodb://dawindb:54AfVcFebuVwf5R4@test-document-db.cluster-cn1ko0h0knji.ap-northeast-2.docdb.amazonaws.com:20177/es-test?authSource=admin&replicaSet=rs0&readPreference=secondaryPreferred&appname=MongoDB%20Compass&retryWrites=false&ssl=false'
/**
...
const LogSchema: Schema = new Schema({
    ...
    actionType: { type: String, enum: ['USER', 'GUEST', 'ADMIN', 'BATCH'], required: true },
